...
$GLOBALS['TL_CSS'][] = "plugins/ia.jquery.shoutbox/shoutbox.default.css";
$GLOBALS['TL_JAVASCRIPT'][] = "plugins/jQuery/jquery.js";
$GLOBALS['TL_JAVASCRIPT'][] = "plugins/jQuery/jquery.cookie.js";
$GLOBALS['TL_JAVASCRIPT'][] = "plugins/JSON/json2.js";
$GLOBALS['TL_JAVASCRIPT'][] = "plugins/ia.jquery.shoutbox/shoutbox.js";
$GLOBALS['TL_JAVASCRIPT'][] = "plugins/ia.jquery.shoutbox/shoutbox_be_starter.js";
...
/*
  ...
  *
    $GLOBALS['BE_MOD']['profile']['privatemessage'] = array
            (
                'tables'       => array('tl_privatemessage'),
                //'key'          => array('Class', 'method'),
                'callback'     => 'ModulePrivateMessage',	// for backend rendering
                'icon'         => 'system/modules/privatemessage/html/icon.png'
 ...
 *
   $GLOBALS['FE_MOD']['miscellaneous'] = array
       (
           'privatemessage' => 'ModulePrivateMessage'
       );
 /* 
...
FB::log(array($_POST['REQUEST_TOKEN'], $_SESSION['REQUEST_TOKEN'], $_SESSION['SHOUTBOX_BYPASS']));
*/
if( (
